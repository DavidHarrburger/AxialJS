...
class AxialMailTemplateSubscriptionDeleted extends AxialMailTemplateBase
{
    constructor()
    {
        super();
        this.name = "subscription_deleted";
    }
    ...
    _getHTML( object )
    {
        ...
        */
        ...
        html += `<div style='text-align: left; color:rgb(35,41,47); font-size:16px;'>Votre abonnement a bien été annulé</div>`;
        html += `<div style='display:block; width:100%; height:10px;'></div>`;
        ...
        html += `<td style='font-size:21px; width:20%; padding-left:10px; font-weight:bold;'><img width='50' height='50' style='width:50px; height:50px;' src='${object.image}' width></td>`;
        html += `<td style='font-size:32px; width:80%; text-align:center; font-weight:bold;'>${object.product}</td>`;
        html += "</tr>";
        html += "</table>";
        html += "</div>";
...
export { AxialMailTemplateSubscriptionDeleted }