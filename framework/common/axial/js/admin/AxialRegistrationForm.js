...
class AxialRegistrationForm extends AxialComponentBase
{
    /// vars
    /** @type { String } */
    #path = "";
    ...
    {
        super();
        this.classList.add("axial_registration_form");
        this.template = "axial-registration-form-template";
    ...
    connectedCallback()
    {
        ...
        this.#username.addEventListener("focusout", this.#boundFocusOutHandler);
        ...
        this.#formElements.push(this.#username, this.#email, this.#password);
    ...
    async #sendForm()
    {
        if( this.#path === "" )
        {
            throw new Error("AxialRegistrationForm.path is not defined");
        }
...
window.customElements.define("axial-registration-form", AxialRegistrationForm);
export { AxialRegistrationForm }