...
class AxialAdminEventViewTicket extends AxialViewBase
{
    /// elements
    ...
    {
        super();
        this.template = "axial-admin-event-view-ticket-template";
...
window.customElements.define("axial-admin-event-view-ticket", AxialAdminEventViewTicket);
export { AxialAdminEventViewTicket }