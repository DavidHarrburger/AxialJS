...
class AxialAdminEventViewStyle extends AxialViewBase
{
    /// elements
    ...
    {
        super();
        this.template = "axial-admin-event-view-style-template";
...
window.customElements.define("axial-admin-event-view-style", AxialAdminEventViewStyle);
export { AxialAdminEventViewStyle }