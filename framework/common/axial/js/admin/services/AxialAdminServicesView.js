...
class AxialAdminServicesView extends AxialAdminViewBase
{
    /// elements
    ...
    {
        super();
        this.template = "axial-admin-services-view-template";
...
window.customElements.define("axial-admin-services-view", AxialAdminServicesView);
export { AxialAdminServicesView }
